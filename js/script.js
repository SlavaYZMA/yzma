    ...
    function showModal(project) {
        if (project === 'chutkost') {
            ...
            modalText.innerHTML = `
                ...
                Влада Иванова, Ирина Даниличева, Александра Далибах, Яна Сорокина<br>
                ...
                Взаимодействие с инсталляцией расширяет наше представление о связи чуткости и экологии, где детское любопытство и бережное отношение к х fragility – это основа экологичной жизни. На сайте проекта размещены полезные материалы об эко-привычках, трендах и челленджах, которые несложно повторить каждому.
            `;
